...
print(f'Are there any non-zero values: {any(values)}')

# TODO: all() will detect if all of the values in a sequence are True
print(f'Are there all non-zero values: {all(values)}')
...
print(f'are there any quake reports that were felt by more than 25,000? :') 
...
print(f'how many quakes were felt by more than 500 people? :')
...
print(f'how many quakes had a magnitude of 6 or larger? :')
